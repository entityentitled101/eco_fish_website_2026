...
const ProductView: React.FC = () => {
    ...
    const otherFish = [
        { name: '草鱼', image: '/other_fish (1).png', highlight: '肉质弹性、鲜美嫩滑' },
        { name: '清波鱼', image: '/other_fish (2).png', highlight: '高蛋白18.1%' },
        { name: '鳊鱼', image: '/other_fish (3).png', highlight: '出肉率高、肉质紧实' }
    ];
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="grid lg:grid-cols-3 gap-6 mb-16">
                    ...
                    <div className="lg:col-span-2 h-96 lg:h-[500px] overflow-hidden shadow-2xl relative group">
                        <img
                            src="/components/fish_display (1).jpg"
                            alt="清水鲈鱼"
                    ...
                    <div className="h-96 lg:h-[500px] overflow-hidden shadow-xl relative group">
                        <img
                            src="/components/fish_display (2).jpg"
                            alt="鱼鳃细节"
