...
const Comparison: React.FC = () => {
    return (
        <section className="py-10 bg-nature-light">
            <div className="container mx-auto px-6">
                <div className="text-center mb-8">
                    <span className="text-gold-600 font-serif tracking-widest text-sm uppercase block mb-3">Comparison</span>
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary-900">为什么选择清水生态？</h2>
                    <div className="w-24 h-1 bg-gold-500 mx-auto mt-6"></div>
                    {/* 动态箭头提示 */}
                    <div className="mt-8 flex justify-center">
                        <ChevronDown
                            size={32}
                            className="text-gold-400/60 animate-bounce"
                            strokeWidth={1.5}
                        />
                    </div>
                </div>
